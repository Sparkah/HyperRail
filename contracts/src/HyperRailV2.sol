...
/// @title HyperRailV2
/// @notice Full-featured deposit and gifting contract for Hyperliquid
/// @dev Includes: depositToSelf, createGift with expiry, claim, refund, simulated HyperCore bridge
contract HyperRailV2 is ReentrancyGuard {
